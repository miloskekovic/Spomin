...
export const DarkTheme = {
  ...
  freeTextColorInvert: Colors.darkBrown,
  buttonBackgroundColor: Colors.beige,
  buttonBackgroundColorPrimary: Colors.beige,
  buttonBackgroundColorSecondary: Colors.darkBrown,
  buttonTextColor: Colors.darkBrown,
  buttonTextColorPrimary: Colors.darkBrown,
  buttonTextColorSecondary: Colors.beige,
